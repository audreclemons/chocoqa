...
Frontend: HTML / JavaScript static form hosted on S3
...
Analytics: Amazon Athena (+ optional Glue Data Catalog)
...
Daily quality trends and failure rate analysis
...
DynamoDB Table: ChocoQA-MasterData
...
DynamoDB Table: ChocoQA-Submissions
...
Queried using Amazon Athena and consumed by Power BI
